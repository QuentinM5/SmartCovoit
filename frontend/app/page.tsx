...
export default function HomePage() {
  ...
  function handleSubmit(e: FormEvent) {
    ...
    if (depotIncomplete || submitting) return;
    setSubmitting(true);
    ...
    createEvent({ id, name, depot_address: depot.address, lat: depot.lat, lon: depot.lon }).catch(() => {
    ...
    <>
      ...
      <main className="mx-auto w-full max-w-3xl px-5 py-10 sm:py-14">
        ...
        <form onSubmit={handleSubmit} className="mx-auto mt-10 flex max-w-lg flex-col gap-6">
          ...
          <div>
            <Button type="submit" disabled={depotIncomplete || submitting}>
